-- Creacion de la base de datos ecomerse
CREATE DATABASE ecommerce;

-- Creacion del usuario de acceso
...
-- Creacion de la tabla de highlights
...
-- Mostrando datos de cada una de las tablas para verificar el ingreso de los datos
USE ecommerce;
